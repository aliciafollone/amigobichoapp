...
import com.amigobicho.com.example.thetwins.amigobichoapp.helper.Permissoes;
...
public class CadastrarAnuncioActivity extends AppCompatActivity
    ...
    private Spinner campoRegiao, campoCategoria;
    private CurrencyEditText campoRecompensa;
    ...
    private Anuncio configurarAnuncio(){
        ...
        String recompensa = campoRecompensa.getText().toString();
    ...
    public void validarDadosAnuncio(View view){
        ...
        String valor = String.valueOf(campoRecompensa.getRawValue());

        if( listaFotosRecuperadas.size() != 0  ){
            if( !anuncio.getRegiao().isEmpty() ){
    ...
    private void carregarDadosSpinner(){
        ...
        String[] estados = getResources().getStringArray(R.array.regioes);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                this, android.R.layout.simple_spinner_item,
                estados
        );
        adapter.setDropDownViewResource( android.R.layout.simple_spinner_dropdown_item );
        campoRegiao.setAdapter( adapter );
    ...
    private void inicializarComponentes(){
        ...
        campoRecompensa = findViewById(R.id.editRecompensa);
        ...
        campoRecompensa.setLocale( locale );
